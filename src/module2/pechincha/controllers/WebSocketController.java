...
public class WebSocketController {
	   ...
	   public WebSocketController(){
		   ...
		   StorageLeilaoEnvironments.iniciarAmbienteLeilao( new Leilao(100,"Venda de Equipamentos Eletrônicos" ,1500, 1 ,2000.00f,"nada",33,null,"Allyson",false, 0) );
		   StorageLeilaoEnvironments.iniciarAmbienteLeilao( new Leilao(200,"Venda de cachorros (de Raça)" ,1500, 1 ,0.5f,"nada",33,null,"Lorena",false, 0) );
	   }; 
